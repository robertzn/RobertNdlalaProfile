    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Robert and I enjoy creating things that live on the internet. My
            ...
            <p>
              Am current desing a course that covers everything you need to build a frant end web
              and mobile application with the css using Node &amp; html.
            </p>
